 ...
 * @property integer $disciplina_id_disciplina
 */
class ProfessorDisciplina extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('professor_id_professor, disciplina_id_disciplina', 'required'),
			array('professor_id_professor, disciplina_id_disciplina', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('professor_id_professor, disciplina_id_disciplina', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('disciplina_id_disciplina',$this->disciplina_id_disciplina);
