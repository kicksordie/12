...
class DepoimentoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(!empty($_POST['Depoimento'])){
			...
			if($model->save()){
				Yii::app()->user->setFlash('success', "Seu comentário foi enviado com sucesso.<br/>Para evitar comentários maldosos, seu comentário será analisado antes de aparecer no sistema.");
				$this->redirect('../professor/view/'.$model->id_professor);
			}
		}
